...
bool ProductUrsaMinorJoystick::setVibration(uint8_t vibration) {
    return writeData({0x02, 7, 191, 0, 0, 3, 0x49, 0, vibration, 0, 0, 0, 0, 0}, "Ursa-Minor-Joystick");
}

bool ProductUrsaMinorJoystick::setLedBrightness(uint8_t brightness) {
    return writeData({0x02, 0x20, 0xbb, 0, 0, 3, 0x49, 0, brightness, 0, 0, 0, 0, 0}, "Ursa-Minor-Joystick");
}
